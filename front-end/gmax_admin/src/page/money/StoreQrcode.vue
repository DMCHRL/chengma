<template>
	<div class="content_box">
		...
		<div class="titling clearfix">
			<span>快捷账户管理</span>
			<button @click="NewRecord">新增快捷账户</button>
...
<script>
	...
	import SaveQrcodePay from "@/components/dialog/SaveQrcodePay"
	...
	export default {
		...
		methods: {
			SaveSetting (val) {
				...
				_this.fetch("/api/payment_img/setImgFlag/"+val,function (res) {
//					console.log(res)
...
//				console.log(item)
			...
			Delete (id) {
				...
				_this.$confirm('此操作将永久删除该记录, 是否继续?', '提示', {
					...
					_this.fetch("/api/payment_img/delete/"+id,function (res) {
						//console.log(res)
						if(res.statusCode == '0000') {
							_this.$message({
								type: 'success',
			...
			initPage () {
				...
				_this.fetch("/api/payment_img/findAll",function (res) {
//					console.log(res)
					if (res.statusCode == "0000") {
