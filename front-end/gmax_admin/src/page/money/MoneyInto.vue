    ...
    export default {
        ...
        methods: {
            ...
            sendCode(val) {
                ...
                _this.post("/api/xxpay/pay_confirm", datas, function(res) {
                    //console.log(res)
                })
            },
            QuitPay() { //快捷支付
                ...
                _this.post("/api/xxpay/createOrder", datas, function(res) {
            ...
            CreateUsdtOrder () {
                ...
                _this.post("/api/usdtOrder/createOrder", datas, function(res) {
                    console.log(res)
                    if (res.statusCode == '0000') {
...
//                         tempwindow.location=res.data;
            ...
            getRate() { //获取汇率
                let _this = this;
                _this.fetch("/api/tlb-rate/realTimeRate", function(res) {
                    if (res.statusCode == "0000") {
            ...
            pushAccount() {
                ...
                if (_this.user.department == "admin" || _this.user.department == "service") {
                    ...
                    _this.post(url, datas, function(res) {
                        if (res.statusCode == "0000") {
            ...
            findWay() {
                let _this = this;
                _this.fetch("/api/receivables_en/findNew", function(res) {
                    // console.log(res)
                    if (res.statusCode == "0000") {
                        if (res.data) {
                            _this.pays.push({
