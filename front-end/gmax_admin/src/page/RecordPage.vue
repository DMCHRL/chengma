<template>
	<div class="content_box">
		...
		<div class="content">
			...
			<details-list @Sort="Sort" :list="listData"></details-list>
			<!--分页-->
...
<script>
	import DetailsList from "@/components/list/DetailsList.vue"
	export default {
		data() {
			return {
				page: {
...
//				console.log(data)
			...
			initPage () {
				...
				_this.post("/api/tlb-trade/pageList",datas,function (res) {
					// console.log(res)
