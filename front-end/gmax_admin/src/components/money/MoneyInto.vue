<template>
	<div class="content_box">
		...
		<div class="message_box">
			...
			<div class="input_box">
				<span>账户姓名</span>
				<el-input class="inline-input" type="text" id="1" placeholder="请输入账户姓名" v-model="accName"></el-input>
			</div>
			<!--<div class="input_box">
				<span>到账货币</span>
			...
			<div class="input_box">
				<span class=" ">到账金额（美元）</span>
				<!--<input type="number" id="2" placeholder="请输入美金金额" v-model="usd" />-->
				<el-input class="inline-input" type="number" id="2" placeholder="请输入美金金额" v-model="usd" @change="usdChange"></el-input>
				<!--<p>最低存款金额1000美金  最高存款金额25000美金</p>-->
			</div>
			<div class="input_box" v-if="pay_type !='4'">
				<span>支付金额（人民币）</span>
				<!--<input type="text" id="3" placeholder="将根据正确的存款金额自动计算" v-model="cny" disabled="disabled"/>-->
				<el-input class="inline-input" type="text" id="3" placeholder="将根据正确的存款金额自动计算" disabled v-model="cny"></el-input>
			</div>
			<div class="input_box">
				<span class=" ">支付平台</span>
				<el-radio-group v-model="pay_type" @change="payChange">
					...
					<!-- <el-radio-button label="2">快捷支付</el-radio-button>
			      <el-radio-button  label="3">微信/支付宝</el-radio-button> -->
			...
			<div v-show="pay_type == '2'">
				...
				<div class="input_box">
					<span>银行卡号</span>
					<!--<input type="number" id="4" placeholder="" v-model="banknum"/>-->
					<el-input type="number" id="4" placeholder="" v-model="banknum" />
					</el-input>
				</div>
			</div>
			<div class="input_box">
