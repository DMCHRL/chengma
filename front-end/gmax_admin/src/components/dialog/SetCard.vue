<template>
	<div class="dialog_box"> 
		...
		<p class="red">银行卡持有人必须与账户名同名，否则视为无效，拒绝提现。</p>
		<div class="input_box">
			<span>开户银行</span>
	...
	export default {
		...
		methods: {
			confirm () {
				...
				_this.post("/api//bank_info/saveBankInfo",datas,function (res) {
//					console.log(res)
			...
			GetBankMess () {
				...
				_this.fetch("/api/bank_info/get/"+_this.userid,function (res) {
//					console.log(res)
					if (res.statusCode == "0000") {
