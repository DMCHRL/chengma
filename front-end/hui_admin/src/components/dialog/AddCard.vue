	...
	export default {
		...
		methods: {
			checkResult () {
				...
				_this.$until.superGet("/api/bind-bank/get/"+ bindid,function (res) {
//					//console.log(res)
...
//				//console.log(val)
				...
				_this.$until.superPost("/api/xxpay/bind_confirm",datas,function (res) {
//					//console.log(res)
			...
			confirm () {
				...
				_this.$until.superPost("/api/xxpay/bind",datas,function (res) {
//					//console.log(res)
