	...
	export default {
		data() {
			return {
				...
				sevenDay: [],
				sevenDate: [
					[115200,88225,59432,116331,62486,191611],
					[10,5,30,22,55,100],
					[1,3,2,6,12,2],
					[1,2,1,0,5,7]
				],
...
// 			this.initData();
		...
		methods: {
			async initData() {
				...
				Promise.all([apiCount(today), userCount(today), orderCount(today), adminDayCount(today), apiAllCount(),
						getUserCount(), getOrderCount(), adminCount()
					])
					.then(res => {
