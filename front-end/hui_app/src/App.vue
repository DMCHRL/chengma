...
// 			}
		...
		methods: {
			...
			onConfirm() {
				//let url = "https://www.pgyer.com/apiv2/app/install?appKey=5a0eb38e3789c50c31504d1bbd537c08&_api_key=023dc27d2bcfa09f2a3b583d8e95ee5a"
			...
			checkIsNew() { //检查app新版本
				...
				// let app_V = plus.runtime.version;
				// alert(app_V)
				let fd = new FormData();
				...
				axios.post(url, fd, {
					...
					let version = response.data.data.buildVersion;
