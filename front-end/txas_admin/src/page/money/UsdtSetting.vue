...
<script>
    export default {
        ...
        methods: {
            ChangeUse () {
                let _this = this;
                this.$until.superGet("/api/digital_currency/changFlag/"+_this.ruleForm.id, function(res) {
            ...
            submitForm(formName) {
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$until.superPost("/api/digital_currency/saveDigitalCurrency", this.ruleForm, function(res) {
                            if (res.statusCode == '0000') {
                                _this.$message({
                                    message: '保存成功',
                                    type: 'success'
            ...
            initData () {
                let _this = this;
                _this.$until.superGet("/api/digital_currency/findAll", function(res) {
                    // console.log(res)
                    if (res.statusCode == '0000') {
