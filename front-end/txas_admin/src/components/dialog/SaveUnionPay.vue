	...
	<el-dialog custom-class="ibs_dialog" width="30%" :show-close="false" :visible="show" append-to-body>
		...
		<div class="input_box clearfix">
			...
			<div class="pull-left right_box">
				<input type="text" placeholder="" v-model="editStore.bank" />
			</div>
		</div>
		<div class="input_box clearfix">
			<div class="pull-left left_box">
		...
		<div class="input_box clearfix">
			<div class="pull-left left_box">
				<span class="import">授权收款人</span>
			</div>
			<div class="pull-left right_box">
				<input type="text" placeholder="" v-model="editStore.name" />
			</div>
		</div>
		<div class="input_box clearfix">
			<div class="pull-left left_box">
				<span class="import">授权银行账号</span>
			</div>
			<div class="pull-left right_box">
				<input type="text" placeholder="" v-model="editStore.bankNum" />
			</div>
		</div>
		<div class="input_box clearfix">
			<div class="pull-left left_box">
			...
			<div class="pull-left right_box">
				<textarea name="" rows="" cols="3" placeholder="" v-model="editStore.remark"></textarea>
			</div>
		</div>
	...
	export default {
		...
		methods: {
			...
			Commit() {
				...
				_this.$until.superPost("/api/receivables/saveReceivables",datas,function (res) {
//					console.log(res)
