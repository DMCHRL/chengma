...
public class DevplatformConstants {
    ...
    public static final Integer USER_LEVEL = 1;        //合伙人默认等级

    //用户初始资产
    public static final Double USER_ASSET_INIT = 0.0;
    public static final String USER_ASSET_FUND_IN = "FUNDIN";  //入金标识
    public static final String USER_ASSET_FUND_JOIN = "FUNDJOIN";  //入伙标识
    public static final String USER_ASSET_FUND_OUT = "FUNDOUT";  //出金标识
    public static final String ASSET_STATUS_APPLYING = "APPLYING";        // 募集中
    public static final String ASSET_STATUS_PASSED = "PASSED";        // 通过
    public static final String ASSET_STATUS_REJECT = "REJECT";        // 拒绝
    ...
    public static final String ABOUT_RISK = "ABOUT_RISK";        //风险报告
