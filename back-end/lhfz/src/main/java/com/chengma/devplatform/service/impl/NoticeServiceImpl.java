...
public class NoticeServiceImpl implements NoticeService {
    ...
    public HashMap<String, Object> sendNotice(SendNoticeDTO sendNoticeDTO) {
        ...
        if(sendNoticeDTO.getType().equals(DevplatformConstants.WHOLE_NOTICE)){
            ...
            list =sendNoticeDTO.getMobileUserDTOList();
        ...
        //添加提醒
        for(MobileUserDTO userCidDTO : list){
    ...
    private void sendToField(SendNoticeDTO sendNoticeDTO, Notice hppNotice, List<MobileUserDTO> list){
        //发送
        if(sendNoticeDTO.getType().equals(DevplatformConstants.WHOLE_NOTICE)){
