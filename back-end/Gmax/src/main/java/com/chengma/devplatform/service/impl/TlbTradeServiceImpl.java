...
public class TlbTradeServiceImpl implements TlbTradeService {
    ...
    @Override
    public void saveList(List<TlbTradeDTO> tlbTradeDTOList) {
        List<TlbTrade> tlbTrades = tlbTradeMapper.toEntity(tlbTradeDTOList);
        tlbTradeRepository.save(tlbTrades);
    }
    ...
    public List<TlbTradeDTO> findAll() {
        return tlbTradeMapper.toDto(tlbTradeRepository.findAll());
    }
    ...
    public HashMap<String, Object> pageList(HashMap<String, Object> params) {
       ...
       // column.append(", ifnull(b.company_money, 0) company_amount, ifnull(b.proxy_money, 0) proxy_amount");
        ...
        StringBuilder cond = new StringBuilder(" from t_tlb_trade a  ");
