...
public class JiguangPushService {
    private static final Logger log = LoggerFactory.getLogger(JiguangPushService.class);
    private static String masterSecret = "4e471063da9c1cff63624952 ";
    private static String appKey = "dc7a5dcdb9ec283f31169290";
