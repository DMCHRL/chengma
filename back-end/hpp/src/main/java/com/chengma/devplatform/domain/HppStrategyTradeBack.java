 ...
 */
@Entity
@Table(name = "t_hpp_strategy_trade_back")
public class HppStrategyTradeBack extends BaseEntity implements Serializable {
    ...
    public Integer getCalcSum() {
        return calcSum;
    }

    public void setCalcSum(Integer calcSum) {
