...
public class UserService {
    ...
    public HashMap<String, Object> findAll(HashMap<String, Object> params) {
       ...
       /* String orderByColumn = formParams.get("orderByColumn") == null ? "" : formParams.get("orderByColumn").toString();
        ...
        StringBuilder cond = new StringBuilder(" from jhi_user u  where c_del_flag='1'");
...
/*    public HashMap<String, Object> findAllAccount(HashMap<String, Object> params) {
    ...
    加载用户信息
     */
    public MobileUserDTO loadInfo(String userId){
        String sql =  "select u.*,i.department,a.i_balance,a.i_total,a.i_used,a.i_net_profit,a.i_fund_profit from t_lhfz_mobile_user u,t_asset a,jhi_user i where  u.c_user_id=a.c_user_id and i.id =u.c_user_id and u.c_user_id='"+userId+"'";
    ...
    public MobileUserDTO loadPowerInfo(HashMap<String,Object> params){
       ...
       /* if(DevplatformConstants.USER_ROLE_ORIGINATOR.equals(department)){
        ...
        String sql =  "SELECT\n" +
                ...
                "\t\t\t0\n" +
                "\t\t) profit_num,\n" +
                "\t\tifnull(sum(d.i_pre_fund), 0) total_pre_fund,\n" +
                "\t\tifnull(\n" +
                "\t\t\t(\n" +
