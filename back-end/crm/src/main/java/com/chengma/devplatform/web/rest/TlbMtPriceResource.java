...
public class TlbMtPriceResource {
    ...
    @GetMapping("/tlb-mt-price/findLastPrice/{symbol}")
    @Timed
    public ResponseEntity<ResponseResult> findLastPrice(@PathVariable String symbol) {
        log.debug("REST request to get a page of TlbMtPrices");
    ...
    @GetMapping("/tlb-mt-price/findAll")
    @Timed
    public ResponseEntity<ResponseResult> findAll() {
        log.debug("REST request to get a page of TlbMtPrices");

        List<TlbMtPriceDTO> tlbMtPriceDTO = tlbMtPriceService.findAll();
        ResponseResult json = new ResponseResult();
        json.setData(tlbMtPriceDTO);
        json.setStatusCode(ResponseResult.SUCCESS_CODE);
        return new ResponseEntity<>(json, null, HttpStatus.OK);
