...
public class TranInfoServiceImpl implements TranInfoService {
    ...
    @Override
    public TranInfoDTO findTranInfoByTransactionId(String transactionId) {
        return tranInfoMapper.toDto(tranInfoRepository.findTranInfoByTransactionId(transactionId));
    }
