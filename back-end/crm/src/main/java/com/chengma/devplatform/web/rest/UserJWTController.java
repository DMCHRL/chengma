...
public class UserJWTController {
    ...
    public ResponseEntity<ResponseResult> authorize(HttpServletRequest request, @Valid @RequestBody LoginVM loginVM, HttpServletResponse response) {
        ...
        return inAuthorize(request, loginVM, response, skip,null);
    }
     ...
     * @return statusCode:成功0000，失败0100。
     */
    public ResponseEntity<ResponseResult> inAuthorize(HttpServletRequest request, @Valid @RequestBody LoginVM loginVM, HttpServletResponse response, boolean skip, TlbAccountDTO tlbAccountDTO) {
        //先默认验证码成功
        ...
        if (ResponseResult.FAIL_CODE.equals(verifyResult.getStatusCode())) {
            ...
            try {
                ...
                if(tlbAccountDTO != null){
                    retMap.put("tlbAccount", tlbAccountDTO);
                }
